...
const Exchanges = {
  HUOBIP2P: { name: "huobip2p"},
  LETSBIT: { name: "letsbit"},
  ARGENBTC: { name: "argenbtc"},
  CALYPSO: { name: "calypso"},
  RIPIO: { name: "ripio"},
  VIBRANT: { name: "vibrant"},
  FIWIND: { name: "fiwind"},
  BUENBIT: { name: "buenbit"},
  BINANCEP2P: { name: "binancep2p"},
  CRYPTOMKT: { name: "cryptomkt"},
  BITSO: { name: "bitso"},
  KRIPTONMARKET: { name: "kriptonmarket"},
  ELUTER: { name: "eluter"},
  BYBITP2P: { name: "bybitp2p"},
  LEMONCASH: { name: "lemoncash"},
  TIENDACRYPTO: { name: "tiendacrypto"},
  PAYDECEP2P: { name: "paydecep2p"},
  OKEXP2P: { name: "okexp2p"},
  SATOSHITANGO: { name: "satoshitango"},
  BYBIT: { name: "bybit"},
  BITGETP2P: { name: "bitgetp2p"},
  PLUSCRYPTO: { name: "pluscrypto"},
  BINGXP2P: { name: "bingxp2p"},
  BELO: { name: "belo"},
  TRUBITP2P: { name: "trubitp2p"},
  SALDO: { name: "saldo"},
  COCOSCRYPTO: { name: "cocoscrypto"},
  PAXFULP2P: { name: "paxfulp2p"},
  RIPIOEXCHANGE: { name: "ripioexchange"},
  BITSOALPHA: { name: "bitsoalpha"},
  DECRYPTO: { name: "decrypto"},
  KUCOINP2P: { name: "kucoinp2p"},
  TRUBIT: { name: "trubit"},
  CRYPTOMKTPRO: { name: "cryptomktpro"},
  LNP2PBOTP2P: { name: "lnp2pbotp2p"},
  COINEXP2P: { name: "coinexp2p"},
  ELDORADOP2P: { name: "eldoradop2p"},
  LEMONCASHP2P: { name: "lemoncashp2p"},
  XAPO: { name: "xapo"}
};
